...
public class PopEntity extends Monster {
	public PopEntity(EntityType<PopEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init(SpawnPlacementRegisterEvent event) {
		event.register(CristianSMasterModEntities.POP.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
