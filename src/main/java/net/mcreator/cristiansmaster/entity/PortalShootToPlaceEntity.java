...
public class PortalShootToPlaceEntity extends AbstractArrow implements ItemSupplier {
	...
	public PortalShootToPlaceEntity(EntityType<? extends PortalShootToPlaceEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public PortalShootToPlaceEntity(EntityType<? extends PortalShootToPlaceEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static PortalShootToPlaceEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PortalShootToPlaceEntity entityarrow = new PortalShootToPlaceEntity(CristianSMasterModEntities.PORTAL_SHOOT_TO_PLACE.get(), entity, world, null);
	...
	public static PortalShootToPlaceEntity shoot(LivingEntity entity, LivingEntity target) {
		PortalShootToPlaceEntity entityarrow = new PortalShootToPlaceEntity(CristianSMasterModEntities.PORTAL_SHOOT_TO_PLACE.get(), entity, entity.level(), null);
