...
public class BigGuyEntity extends Monster {
	public BigGuyEntity(EntityType<BigGuyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init(SpawnPlacementRegisterEvent event) {
		event.register(CristianSMasterModEntities.BIG_GUY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
