...
public class IceshardEntity extends AbstractArrow implements ItemSupplier {
	...
	public IceshardEntity(EntityType<? extends IceshardEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public IceshardEntity(EntityType<? extends IceshardEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static IceshardEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		IceshardEntity entityarrow = new IceshardEntity(CristianSMasterModEntities.ICESHARD.get(), entity, world, null);
	...
	public static IceshardEntity shoot(LivingEntity entity, LivingEntity target) {
		IceshardEntity entityarrow = new IceshardEntity(CristianSMasterModEntities.ICESHARD.get(), entity, entity.level(), null);
