package net.mcreator.cristiansmaster.world.features;
...
import net.mcreator.cristiansmaster.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, CristianSMasterMod.MODID);
