...
public class TNTDimensionTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("cristian_s_master:tnt_dimension_portal"), poiType);
	...
	public TNTDimensionTeleporter(ServerLevel level) {
		this.level = level;
	}
