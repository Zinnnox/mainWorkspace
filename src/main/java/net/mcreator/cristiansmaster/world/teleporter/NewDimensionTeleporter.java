...
public class NewDimensionTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("cristian_s_master:new_dimension_portal"), poiType);
	...
	public NewDimensionTeleporter(ServerLevel level) {
		this.level = level;
	}
