...
import net.mcreator.cristiansmaster.procedures.GrimoireItemInHandTickProcedure;
import net.mcreator.cristiansmaster.item.renderer.GrimoireItemRenderer;
...
public class GrimoireItem extends Item implements GeoItem {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			GrimoireItemInHandTickProcedure.execute(world, entity, itemstack);
	}
}
