...
public class IroncladRenderer extends GeoEntityRenderer<IroncladEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IroncladEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
