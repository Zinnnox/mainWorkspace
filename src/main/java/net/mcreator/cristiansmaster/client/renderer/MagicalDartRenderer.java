...
public class MagicalDartRenderer extends EntityRenderer<MagicalDartEntity> {
	...
	@Override
	public void render(MagicalDartEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(MagicalDartEntity entity) {
		return texture;
	}
}
