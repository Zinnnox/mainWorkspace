...
import net.mcreator.cristiansmaster.init.CristianSMasterModLayerDefinitions;
...
public class BackpackRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("cristian_s_master", "textures/entities/texture.png");
	private final Modelbackpack model;

	public BackpackRenderer() {
		this.model = new Modelbackpack(Minecraft.getInstance().getEntityModels().bakeLayer(CristianSMasterModLayerDefinitions.BACKPACK));
	}
