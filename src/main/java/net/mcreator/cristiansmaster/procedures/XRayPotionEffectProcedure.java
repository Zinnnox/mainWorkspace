...
public class XRayPotionEffectProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(CristianSMasterModMobEffects.X_RAY) ? _livEnt.getEffect(CristianSMasterModMobEffects.X_RAY).getDuration() : 0) > 0) {
			posX = x - 20;
			posY = y - 20;
			posZ = z - 20;
