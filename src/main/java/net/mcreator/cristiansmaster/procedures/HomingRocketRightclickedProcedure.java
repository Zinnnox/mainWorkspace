...
public class HomingRocketRightclickedProcedure {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, float damage, int knockback, byte piercing) {
						AbstractArrow entityToSpawn = new HomingProjectileEntity(CristianSMasterModEntities.HOMING_PROJECTILE.get(), level) {
							@Override
