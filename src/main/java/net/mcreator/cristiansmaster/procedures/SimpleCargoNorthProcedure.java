...
public class SimpleCargoNorthProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		if (emptySlots == 0) {
			if ((new Object() {
				...
				world.setBlock(BlockPos.containing(x, y, z + 1), dropBlock, 3);
				cargoCartSlot = 0;
				dumpBlockSlot = 0;
				for (int index1 = 0; index1 < (int) cargoCartMaxSlots; index1++) {
					for (int index2 = 0; index2 < (int) dropBlockMaxSlots; index2++) {
						...
						}.getAmount(world, BlockPos.containing(x, y, z + 1), (int) dumpBlockSlot) == 0) {
