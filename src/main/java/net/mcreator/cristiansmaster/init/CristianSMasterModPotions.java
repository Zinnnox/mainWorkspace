...
public class CristianSMasterModPotions {
	...
	public static final DeferredHolder<Potion, Potion> RANDOMIZER_POTION = REGISTRY.register("randomizer_potion", () -> new Potion(new MobEffectInstance(CristianSMasterModMobEffects.RANDOMIZE_MOB_HEIGHT_EFFECT, 200, 0, false, true)));
